...
var isTruthy = function(value){
  return value ? true : false;    // ou !!value;
};
...
carro.addPessoa = function(numeroPessoas){
  ...
  if( totalPessoas > carro.assentos ){
    ...
    var pluralOuSingular = lugaresVagos === 1 ? 'pessoa' : 'pessoas';
    return `Só cabem mais ${lugaresVagos} ${pluralOuSingular}!`;
  }
...
carro.addPessoa(4);   // 'Só cabem mais 3 lugares no carro !'
